...
class HtmlTest {
	...
	bool string_manip() {
		...
		myassert(HTML::decode_entities(entities) == "nos somos do clube atletico mineiro � � brasil   &teste; �� &aacute � &end   ");
		...
		myassert(HTML::convert_link(link3, root_link) == "http://www.akwan.com.br/teste/servi�o.html");
...
class CharsetTest
{
	public:
		void test()
		{
			...
			myassert(cc.convert("Você é o meu visitante número") == "Voc� � o meu visitante n�mero");

			CharsetConverter cc2("ISO-8859-1", "UTF8");
			myassert(cc2.convert("Voc� � o meu visitante n�mero") == "Você é o meu visitante número");
		}
};
